/**
 * Test file for Job: build-time-trends
 */

var assert = require ('assert');
var build_time_trends_SUT = require('../build-time-trends');

var mockedConfig, mockedDependencies;

describe ('build-time-trends test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      build_time_trends_SUT.onRun(config, mockedDependencies, function(err, data){

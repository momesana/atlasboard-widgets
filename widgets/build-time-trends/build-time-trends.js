...
widget = {
	createChart: function (canvas, buildTimeDetails) {
        const chartColors = [
            'rgb(54, 162, 235)',  // blue
            'rgb(255, 99, 132)',  // red
        ...
        const buildDurations = (data) => data.reduce((acc, { duration, timestamp }) => {
            acc.push({
        ...
        const buildJobData = ({job, data}, index) => Object.assign({
            label: job,
            fill: true,
            borderWidth: 2,
            pointRadius: 5,
